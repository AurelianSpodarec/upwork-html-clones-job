      ...
      ? messages
        .map((message) => {
          if (message.sender === "user") {
            ...
            return `
            <div id="js-message-ai" class="flex-start leading-5 text-[17px] flex gap-3 text-base juice:gap-4 juice:md:gap-5 juice:lg:gap-6 md:max-w-3xl lg:max-w-[40rem] xl:max-w-[48rem]"><div class="flex-shrink-0 flex flex-col relative items-end"><div class="-mt-2.5 rounded-full overflow-hidden p-1 "><img src="https://pbs.twimg.com/profile_images/1369223787074445314/K8UkNVMV_400x400.jpg" class="h-8 w-8"></div></div><div id="js-message-ai-content" class="bg-white relative flex w-full min-w-0 flex-col agent-turn">${message.text}</div></div>  
            `;
          }
        })
        .join("")
      : `<div id="js-chat-start" class="text-center m-auto"><img src="https://pbs.twimg.com/profile_images/1369223787074445314/K8UkNVMV_400x400.jpg" class="h-20 w-20 mx-auto"><div><h2 class="text-3xl">Welcome to Fongit Advisor AI</h2><p> Ask me anything about Fongit, and I'll provide you with the information you need!</p></div></div>`;
  }
